...
extern "C" LM_API AdtObj* lmx_units_convert(QuantityObj* value,
                                                  const char* target_unit) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API AdtObj* lmx_units_value(QuantityObj* value) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API double lmx_units_strip(QuantityObj* value) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API StringObj* lmx_units_unit(QuantityObj* value) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API AdtObj* lmx_units_is_dimensionless(QuantityObj* value) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API AdtObj* lmx_units_add(QuantityObj* lhs, QuantityObj* rhs) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API AdtObj* lmx_units_subtract(QuantityObj* lhs, QuantityObj* rhs) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API AdtObj* lmx_units_multiply(QuantityObj* lhs, QuantityObj* rhs) noexcept try {
    ensure_lmmc_runtime();
...
extern "C" LM_API AdtObj* lmx_units_divide(QuantityObj* lhs, QuantityObj* rhs) noexcept try {
    ensure_lmmc_runtime();
