...
extern "C" LM_API double lmx_complex_numbers_real_part(ComplexObj* value) {
    return value ? value->real() : 0.0;
}

extern "C" LM_API double lmx_complex_numbers_imaginary_part(ComplexObj* value) {
...
extern "C" LM_API AdtObj* lmx_complex_numbers_conjugate(ComplexObj* value) {
...
extern "C" LM_API AdtObj* lmx_complex_numbers_absolute_value(ComplexObj* value) {
...
AdtObj* fft_transform(ArrayObj* values, const bool inverse) {
    ...
    for (std::size_t index = 0; index < real.size(); ++index) {
        result->append(Value(new ComplexObj(real[index], imag[index]),
                             ValueKind::Complex));
    }
...
extern "C" LM_API AdtObj* lmx_complex_numbers_argument(ComplexObj* value) {
    lmmc_complex_t input{};
    if (!checked_complex(value, input))
...
extern "C" LM_API AdtObj* lmx_complex_numbers_exponential(ComplexObj* value) {
    return complex_unary("complex.exp", value, lmmc_complex_exp);
}
extern "C" LM_API AdtObj* lmx_complex_numbers_natural_logarithm(ComplexObj* value) {
    return complex_unary("complex.log", value, lmmc_complex_log);
}
extern "C" LM_API AdtObj* lmx_complex_numbers_square_root(ComplexObj* value) {
    return complex_unary("complex.sqrt", value, lmmc_complex_sqrt);
}
extern "C" LM_API AdtObj* lmx_complex_numbers_sine(ComplexObj* value) {
    return complex_unary("complex.sin", value, lmmc_complex_sin);
}
extern "C" LM_API AdtObj* lmx_complex_numbers_cosine(ComplexObj* value) {
    return complex_unary("complex.cos", value, lmmc_complex_cos);
}
extern "C" LM_API AdtObj* lmx_complex_numbers_power(
    ComplexObj* base, ComplexObj* exponent) {
...
extern "C" LM_API AdtObj* lmx_fast_fourier_transform_forward(ArrayObj* values) {
    return fft_transform(values, false);
}
extern "C" LM_API AdtObj* lmx_fast_fourier_transform_inverse(ArrayObj* values) {
