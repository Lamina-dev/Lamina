...
extern "C" LM_API AdtObj* lmx_computer_algebra_calculus_implicit_differentiate_by_names(
    ExprObj* expression, const char* independent, const char* dependent) {
    std::string error;
    const auto* value = checked_expr(expression, error);
    if (!value)
        return result_error(MathErrorCode::InvalidArgument,
...
extern "C" LM_API AdtObj* lmx_computer_algebra_series_laurent_series_by_name(
    ...
    const LmInt negative_order, const LmInt positive_order) {
    std::string error;
    const auto* value = checked_expr(expression, error);
...
extern "C" LM_API AdtObj* lmx_computer_algebra_series_asymptotic_by_name(
    ExprObj* expression, const char* variable, const LmInt order) {
    std::string error;
    const auto* value = checked_expr(expression, error);
...
extern "C" LM_API AdtObj* lmx_computer_algebra_integral_transforms_laplace_by_symbols(ExprObj* e, ExprObj* a, ExprObj* b) {
...
extern "C" LM_API AdtObj* lmx_computer_algebra_integral_transforms_inverse_laplace_by_symbols(ExprObj* e, ExprObj* a, ExprObj* b) {
    std::string x, y, error;
    if (!checked_symbol_name(a, x, error) || !checked_symbol_name(b, y, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_integral_transforms_fourier_by_symbols(ExprObj* e, ExprObj* a, ExprObj* b) {
    std::string x, y, error;
    if (!checked_symbol_name(a, x, error) || !checked_symbol_name(b, y, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_integral_transforms_inverse_fourier_by_symbols(ExprObj* e, ExprObj* a, ExprObj* b) {
    std::string x, y, error;
    if (!checked_symbol_name(a, x, error) || !checked_symbol_name(b, y, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_integral_transforms_z_transform_by_symbols(ExprObj* e, ExprObj* a, ExprObj* b) {
    std::string x, y, error;
    if (!checked_symbol_name(a, x, error) || !checked_symbol_name(b, y, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_integral_transforms_convolve_by_symbol(ExprObj* a, ExprObj* b, ExprObj* v) {
...
extern "C" LM_API AdtObj* lmx_computer_algebra_residue_by_symbol(ExprObj* e, ExprObj* v, ExprObj* p, LmInt n) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_cauchy_integral_by_symbol(ExprObj* e, ExprObj* v, ExprObj* p, LmInt n) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_is_analytic_by_symbol(ExprObj* e, ExprObj* v) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_calculus_implicit_differentiate_by_symbols(ExprObj* e, ExprObj* a, ExprObj* b) {
    std::string x, y, error;
    if (!checked_symbol_name(a, x, error) || !checked_symbol_name(b, y, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_series_laurent_series_by_symbol(ExprObj* e, ExprObj* v, ExprObj* c, LmInt n, LmInt p) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_series_asymptotic_by_symbol(ExprObj* e, ExprObj* v, LmInt n) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_series_symbolic_sum_by_symbol(ExprObj* e, ExprObj* v, ExprObj* l, ExprObj* u) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
...
extern "C" LM_API AdtObj* lmx_computer_algebra_series_symbolic_product_by_symbol(ExprObj* e, ExprObj* v, ExprObj* l, ExprObj* u) {
    std::string name, error;
    if (!checked_symbol_name(v, name, error)) return result_error(MathErrorCode::InvalidArgument, __func__, std::move(error));
