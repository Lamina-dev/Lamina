...
extern "C" LM_API AdtObj* lmx_linear_algebra_matrix(ArrayObj* rows) {
...
extern "C" LM_API LmInt lmx_linear_algebra_row_count(MatrixObj* value) {
    return value ? static_cast<LmInt>(value->rows()) : 0;
}

extern "C" LM_API LmInt lmx_linear_algebra_column_count(MatrixObj* value) {
...
extern "C" LM_API LmInt lmx_computer_algebra_table_size(TableObj* value) {
    return value ? static_cast<LmInt>(value->entries().size()) : 0;
}

extern "C" LM_API bool lmx_computer_algebra_table_has(TableObj* value, const char* key) {
    return value && key && value->find(key) != nullptr;
}

extern "C" LM_API AdtObj* lmx_computer_algebra_table_vector(TableObj* value, const char* key) {
...
extern "C" LM_API AdtObj* lmx_computer_algebra_table_matrix(TableObj* value, const char* key) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_matrix_norm(MatrixObj* value) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_transpose(MatrixObj* value) {
    return lmmc_matrix_unary_result("matrix_transpose", value,
                                    lmmc_lsr_linalg_transpose);
}

extern "C" LM_API AdtObj* lmx_linear_algebra_multiply(MatrixObj* lhs, MatrixObj* rhs) {
    return lmmc_matrix_binary_result("matrix_mul", lhs, rhs,
                                     lmmc_lsr_linalg_matmul);
}

extern "C" LM_API AdtObj* lmx_linear_algebra_matrix_vector_product(MatrixObj* matrix, VectorObj* vector) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_identity_matrix(const LmInt size) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_diagonal_matrix(VectorObj* diagonal) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_add(MatrixObj* lhs, MatrixObj* rhs) {
    return lmmc_matrix_binary_result("matrix_add", lhs, rhs,
                                     lmmc_lsr_linalg_mat_add);
}

extern "C" LM_API AdtObj* lmx_linear_algebra_subtract(MatrixObj* lhs, MatrixObj* rhs) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_adjoint(MatrixObj* value) {
    return lmmc_matrix_unary_result("matrix_adjoint", value,
                                    lmmc_lsr_linalg_adjoint);
}

extern "C" LM_API AdtObj* lmx_linear_algebra_inverse(MatrixObj* value) {
    return lmmc_matrix_unary_result("matrix_inverse", value,
                                    lmmc_lsr_linalg_inv);
}

extern "C" LM_API AdtObj* lmx_linear_algebra_det(MatrixObj* value) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_trace(MatrixObj* value) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_rank(MatrixObj* value) {
...
extern "C" LM_API AdtObj* lmx_linear_algebra_shape(MatrixObj* value) {
    if (!value || !value->valid())
...
extern "C" LM_API AdtObj* lmx_linear_algebra_one_norm(MatrixObj* value) {
    if (!value || !value->valid())
...
extern "C" LM_API AdtObj* lmx_linear_algebra_infinity_norm(MatrixObj* value) {
    if (!value || !value->valid())
...
extern "C" LM_API AdtObj* lmx_linear_algebra_least_squares(
    MatrixObj* matrix, VectorObj* rhs) {
    ...
    auto* factor = copied_matrix(matrix);
    auto qr = matrix_view(factor);
...
extern "C" LM_API AdtObj* lmx_linear_algebra_solve_triangular(
    MatrixObj* matrix, VectorObj* rhs, bool upper, bool unit_diagonal) {
    if (!matrix || !matrix->valid() || !rhs ||
        matrix->rows() != matrix->cols() || rhs->size() != matrix->rows())
